...
web build:
 - http://mootools.net/core/5fe26fac6a5529eaf7e640ae8ad6af45

packager build:
 - packager build Core/Class Core/Class.Extras Core/Element.Dimensions Core/Request Core/Request.HTML Core/DOMReady
...
}};Element.implement({load:function(){this.get("load").send(Array.link(arguments,{data:Type.isObject,url:Type.isString}));return this;}});(function(){var b={};
